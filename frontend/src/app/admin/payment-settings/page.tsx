...
const METHODS: MethodConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'shortcode', label: 'Shortcode (Store Number)', type: 'text', placeholder: '174379', hint: 'This is your Store Number. Use 174379 for sandbox.' },
      { key: 'tillNumber', label: 'Till Number', type: 'text', placeholder: 'e.g. 5123456', hint: 'The 5-7 digit Buy Goods Till number.' },
